odoo.define('pos_retail.StockInformation', function (require) {
    ...
    class StockInformation extends PosComponent {
        constructor() {
            ...
            let qty_available = this.env.pos.db.stock_datas[this.props.product.id];
            let currentStockLocation = selectedOrder.get_picking_source_location()
            this.stocks = [{
        ...
        async buildStock() {
            ...
            let stock_datas = await this.env.pos._get_stock_on_hand_by_location_ids([this.props.product.id], stock_location_ids)
